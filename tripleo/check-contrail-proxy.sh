...
run_opts="SSH_CMD=$SSH_CMD MAX_FAIL=$MAX_FAIL DEBUG=$DEBUG OPENSTACK_VERSION=$OPENSTACK_VERSION DPDK=$DPDK"
run_opts+=" KEYSTONE_API_VERSION=$KEYSTONE_API_VERSION"
