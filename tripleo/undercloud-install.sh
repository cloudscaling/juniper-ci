...
ssh -t $ssh_opts $ssh_addr "NUM=$NUM NETDEV=$NETDEV OPENSTACK_VERSION=$OPENSTACK_VERSION ENVIRONMENT_OS=$ENVIRONMENT_OS RHEL_CERT_TEST=$RHEL_CERT_TEST /root/__undercloud-install-1-as-root.sh"
