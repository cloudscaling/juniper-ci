...
$SSH "echo SystemMaxUse=1G | sudo tee -a /etc/systemd/journald.conf.d/size.conf > /dev/null"
$SSH "echo RuntimeMaxUse=1G | sudo tee -a /etc/systemd/journald.conf.d/size.conf > /dev/null"
